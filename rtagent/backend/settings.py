...
RECOGNIZED_LANGUAGE: List[str] = ["en-US", "es-ES", "fr-FR", "ko-KR", "it-IT"]  # Default language for speech recognition
AUDIO_FORMAT: str = "pcm"  # Audio format for speech recognition

#AGENT CONFIG 
AGENT_AUTH_CONFIG: str = "rtagent/backend/agents/agent_store/auth_agent.yaml"  # Default agent name
AGENT_CLAIM_INTAKE_CONFIG: str = "rtagent/backend/agents/agent_store/claim_intake_agent.yaml"
