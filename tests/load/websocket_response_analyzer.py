...
class WebSocketResponseAnalyzer:
    ...
    async def analyze_message(self, message: str):
        ...
        try:
            ...
            elif ('speech' in response_kind.lower() or 
                  'recognition' in response_kind.lower() or
                  'recognized' in response_data):
            ...
            # Look for any response with interesting content
                ...
                print(f"  🔍 Response type '{response_kind}': {json.dumps(response_data, indent=2)[:200]}...")
...
async def main():
    ...
    parser.add_argument("--url", "-u", default="ws://localhost:8010/api/v1/media/stream",
